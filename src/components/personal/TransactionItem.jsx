...
export default function TransactionItem({ tx, onDelete, onRequestDelete, onEdit }) {
  ...
  return (
    <div style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        {swiped && (
          <motion.button
            ...
            style={{
              ...
              background: 'var(--expense)', border: 'none', cursor: 'pointer',
      ...
      <motion.div
        ...
        onClick={() => {
          if (!dragging.current && !swiped && onEdit) onEdit(tx)
        }}
        style={{
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          padding: '12px 20px', minHeight: '64px',
          background: 'transparent', cursor: onEdit ? 'pointer' : 'default',
      ...
      >
        ...
        <div style={{ textAlign: 'right', flexShrink: 0, marginLeft: '12px' }}>
          <p style={{ fontFamily: 'Space Grotesk, sans-serif', fontWeight: 600, fontSize: '16px', color: 'var(--expense)' }}>
            -{formatCOP(tx.monto)}
          </p>
